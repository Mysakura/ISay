            ...
            <table class="table">
                ...
                <c:forEach items="${data }" var="i">
	                <tr>
	                    ...
	                    <td>${i.areaName }</td>
	                    <td>
	                        <a href="${pageContext.request.contextPath }/area/labels/${i.areaId }" class="btn btn-primary btn-sm">查看标签</a>
	                        <a href="javascript:;" class="btn btn-success btn-sm" data-role="addLabel" data-area="${i.areaName }" data-areaid="${i.areaId }">添加标签</a>
	                    </td>
	                </tr>
                </c:forEach>
                </tbody>
