    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="side-menu hidden-xs">
                <h2 class="title">资源<span class="glyphicon glyphicon-download-alt"></span></h2>
                <ul class="list-group list-unstyled">
                	<jsp:include page="common/area.jsp"></jsp:include>
                </ul>
                <div class="write-post-link">
                    <a href="${pageContext.request.contextPath }/card/write_post?type=resource">我也写一个</a>
                </div>
            </div>
            <div class="main-content">
                <ul class="list-group post-wrap">
                    <!-- <li class="list-group-item">比如点击技术：显示技术相关资源，仅仅支持百度云链接</li> -->
