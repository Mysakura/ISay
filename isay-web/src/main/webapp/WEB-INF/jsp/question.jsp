    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="side-menu hidden-xs">
                <h2 class="title">疑问<span class="glyphicon glyphicon-question-sign"></span></h2>
                <ul class="list-group list-unstyled">
                    <jsp:include page="common/area.jsp"></jsp:include>
                </ul>
                <div class="write-post-link">
                    <a href="${pageContext.request.contextPath }/card/write_post?type=question">我也写一个</a>
                </div>
            </div>
            <div class="main-content">
                <ul class="list-group post-wrap">
                    <!-- <li class="list-group-item">比如点击技术：显示技术相关问题，标题，标签</li> -->
