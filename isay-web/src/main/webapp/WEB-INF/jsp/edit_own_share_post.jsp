...
<div class="container-fluid isay-container">
    <div class="row">
        <div class="col-xs-12">
            <h3 class="text-center">修改：<span class="text-danger">${title }</span></h3>
        </div>
        <div class="col-xs-12">
            <div class="editormd" id="editormd_warp">
                <textarea data-role="write" class="editormd-markdown-textarea" name="postMarkdown" form="poform">${postMarkdown }</textarea>
        ...
        <div class="col-xs-12">
            <form action="${pageContext.request.contextPath }/card/save_own_share_post" method="post" id="poform">
