    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="side-menu hidden-xs">
                <h2 class="title">技能图 <span class="glyphicon glyphicon-flag"></span></h2>
                <ul class="list-group list-unstyled">
                    <jsp:include page="common/area.jsp"></jsp:include>
                </ul>
                <div class="write-post-link">
                    <p>完善说明：这部分任何人都有权限修改，只为资源更加完善</p>
                    <a href="${pageContext.request.contextPath }/card/write_post?type=job">我也写一个</a>
                </div>
            </div>
                ...
                <ul class="list-group post-wrap">
                    <c:forEach items="${response.data }" var="i">
	                    <li class="list-group-item post-item" id="${i.postId }">
	                        <h3 class="h3"><a href="${pageContext.request.contextPath }/card/share_post_details/${i.postId }">${i.postTitle }</a></h3>
	                        ...
	                        <div>
	                            ...
	                            <a href="${pageContext.request.contextPath }/card/edit_share_post/${i.postId }">参与完善</a>
	                            <div class="pull-right">
	                                <span>领域:</span>
