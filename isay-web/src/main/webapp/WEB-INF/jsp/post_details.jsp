                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="user-info">
                                ...
                                <div class="user-extra">
                                    <a href="#">Tom</a>
                                    <span class="comment-time">2017-08-24-22:27:45</span>
                                </div>
                                <div class="user-operate">
                                    <a href="javascript:;" class="user-operate-btn">回复</a>
                                </div>
                            </div>
                            <div class="comment">此次发布的为java EE 8.0 ,Tomcat 9.x与之相对应，但是现在还处于alpha版</div>
                            <div class="pd-reply-wrap">
                                <ul class="list-unstyled">
                                    <li class="pd-reply">
                                        <div class="user-info">
                                        ...
                                        <div class="reply">特么的JDK9在linux上就没成功加载过，不是找不到系统库就是找不到系统库</div>
                                        <div class="user-operate">
                                            <span class="reply-time">2017-08-24 23:00:15</span>
                                            <a href="javascript:;" class="user-operate-btn">回复</a>
                                        </div>
                                    </li>
                                    <li class="pd-reply">
                                        ...
                                        <div class="reply">已经完善部分细节，有问题欢迎提出</div>
                                        <div class="user-operate">
                                            <span class="reply-time">2017-08-24 23:00:15</span>
                                            <a href="javascript:;" class="user-operate-btn">回复</a>
                                        </div>
                                ...
                                -->
                                <!--<div class="well pd-release-comment-wrap pd-release-reply-wrap">-->
                                    <!--<div id="say-reply" class="comment-input reply-input" contenteditable="true" data-tip="回复 Mary"></div>-->
                                    <!--<div class="comment-tools">-->
                                        ...
                                        <!--<a class="tool-btn" href="javascript:;">-->
                                            ...
                                            <!--<input class="file-input" type="file" accept="image/jpeg,image/png,image/gif" name="replyFile" id="replyFile">-->
                                        <!--</a>-->
                                    <!--</div>-->
                                <!--</div>-->
                                <!--  
